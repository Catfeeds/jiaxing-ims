<div class="padder">
    ...
    <table id="supplier-dialog">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="name" data-sortable="true" data-align="left">名字</th>
            <th data-field="login" data-width="200" data-sortable="true" data-align="left">账号</th>
...
(function($) {
    ...
    search.find('#search-submit').on('click', function() {
        ...
        $table.bootstrapTable('refresh', {
            url:app.url('supplier/supplier/dialog', data)
        });
        return false;
    });
})(jQuery);
