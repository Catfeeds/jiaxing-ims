...
<div class="panel no-border">
    ...
    @include('tabs', ['tabKey' => 'stock.purchase-return'])
...
<div class="row row-sm row-todo">
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="panel">
            ...
            <div class="todo-text">
                <div class="text-md" style="color:#2c83e4;">本日退货金额</div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="panel">
            ...
            <div class="todo-text">
                <div class="text-md" style="color:#fd875a;">本月退货金额</div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="panel">
            ...
            <div class="todo-text">
                <div class="text-md" style="color:#27c24c;">累计退货金额</div>
