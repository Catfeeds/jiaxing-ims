...
<div class="form-group">
    <label class="col-sm-2 control-label" for="is_share">共享服务 </label>
    <div class="col-sm-10">
        <label class="checkbox-inline"><input type="checkbox" id="is_share" name="is_share" value=""> 是否共享该服务</label>
    </div>
</div>
