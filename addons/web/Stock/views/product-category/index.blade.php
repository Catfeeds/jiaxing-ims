<div class="panel no-border">
    ...
    @include('tabs', ['tabKey' => 'stock.product'])
...
<script>
var routes = {
    index: 'stock/product-category/index',
    create: 'stock/product-category/create',
    delete: 'stock/product-category/delete',
    edit: 'stock/product-category/edit',
    show: 'stock/product-category/show',
    export: 'stock/product-category/export',
};
var $table = null;
