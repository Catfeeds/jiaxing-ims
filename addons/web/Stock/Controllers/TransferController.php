...
class TransferController extends DefaultController
{
    // 首页
    ...
    // 调入审核
    public function auditInputAction()
    {
        return $this->audit(6);
    }

    // 调出审核
    public function auditOutputAction()
    {
        return $this->audit(7);
    }
    ...
    public function deleteAction()
    {
        if (Request::method() == 'POST') {
            ...
            return $this->json('恭喜你，采购退货删除成功。', true);
        }
    }
}
