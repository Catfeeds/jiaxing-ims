...
<tr>
    <td align="right" width="100">流程名称 <span style="color:red;">*</span></td>
    <td><input type="text" id="title" name="title" value="{{$row['title']}}" class="form-control input-sm"></td>
</tr>

<tr>
    <td align="right">部门权限 <span style="color:red;">*</span></td>
    <td>
        {{Dialog::user('department','auth_department',$row['auth_department'], 1, 0)}}
    </td>
</tr>

<tr>
    <td align="right">角色权限 <span style="color:red;">*</span></td>
    <td>
        {{Dialog::user('role','auth_role',$row['auth_role'], 1, 0)}}
    </td>
</tr>

<tr>
    <td align="right">用户权限 <span style="color:red;">*</span></td>
    <td>
        {{Dialog::user('user','auth_user',$row['auth_user'], 1, 0)}}
    </td>
</tr>
...
<tr>
    ...
    <td>
        {{Dialog::search($row, 'id=sponsor_id&name=sponsor_name&multi=1')}}
    </td>
</tr>
...
<tr>
    ...
    <td>
        {{Dialog::search($row, 'id=query_id&name=query_name&multi=1')}}
    </td>
</tr>
...
<tr>
    ...
    <td align="left">
        <select class="form-control input-inline input-sm" name="category_id" id="category_id">
            <option value=""> - </option>
             @if(count($category)) @foreach($category as $k => $v)
