...
var condition = {
    ...
    addLeft:function(id)
    {
        ...
        if(oObj.options.length > 0)
        {
            ...
            //有条件才能添加左括号表达式
            $.toastr('error', '请先添加条件，再选择括号', '步骤设计');
            return;
        }
        ...
        {
            $.toastr('error', '无法编辑已经存在关系的条件', '步骤设计');
            return;
        }
        ...
        if(sText.indexOf('(') >= 0)
        {
            ...
            {
                $.toastr('error', '条件表达式书写错误,请检查括号匹配', '步骤设计');
                return;
            } else {
...
<div class="tab-content">
        ...
        <table class="table table-form">
            ...
            <tr>
                ...
                <td><div class="input-group">
                        ...
                        <span class="bg-white input-group-addon"><a href="javascript:;" data-container="body" data-toggle="tooltip" title="允许为小数，表示接收工作后办理的时限，为空表示不限时。"><i class="icon icon-info-sign"></i></a></span>
                    </div>
                </td>
            </tr>
    ...
    <div class="tab-pane" id="tabs-2">
        ...
        <tr>
            <td width="15%">经办权限</td>
            <td>{{Dialog::search($row,'id=permission_id&name=permission_name&multi=1')}}</td>
        </tr>
        ...
        <tr>
            ...
            <td><div class="input-group">
                    ...
                    <span class="bg-white input-group-addon"><a href="javascript:;" data-container="body" data-toggle="tooltip" title="选人过滤规则在流程转交选择办理人员时生效。默认设置为只能选择指定办理人员"><i class="icon icon-info-sign"></i></a></span>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><div class="input-group">
                    ...
                    <span class="bg-white input-group-addon">
                        <a href="javascript:;" data-container="body" data-toggle="tooltip" title="自动选人规则,使流程办理人通过指定规则智能选择。默认设置为：不自动选择。注意，请同时设置好经办权限，自动选人规则才能生效。"> <i class="icon icon-info-sign"></i></a>
                    </span>
                </div>
                ...
                <div class="m-t" id="select_user" style="display:none;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Dialog::user('user','select_user_id',$row['select_user_id'], 0, 0)}}
                        </div>
                   </div>
                   <div class="form-group">
                        <label class="col-sm-2 control-label">会签人</label>
                        <div class="col-sm-10">
                            {{Dialog::user('user','select_user_sign',$row['select_user_sign'], 1, 0)}}
                        </div>
                    </div>
                </div>
