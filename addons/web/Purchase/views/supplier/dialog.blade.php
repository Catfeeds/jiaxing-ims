<div class="padder">
    ...
    <div class="m-t-sm m-b-sm">
        <form id="purchase-supplier-dialog-search-form" name="mysearch" class="form-inline" method="get">
            @include('searchForm')
        </form>
    </div>

    <table id="purchase-supplier-dialog">
        <thead>
        <tr>
...
(function($) {
    var $table = $('#purchase-supplier-dialog');
    ...
    var search = $('#purchase-supplier-dialog-search-form').searchForm({
        data: data,
        init:function(e) {
            var self = this;
        }
    ...
    search.find('#search-submit').on('click', function() {
        ...
        $table.bootstrapTable('refresh', {
            url:app.url('purchase/supplier/dialog', data)
        });
        return false;
    });
})(jQuery);
