...
<div class="panel m-b-none">
    ...
    <table class="table table-form m-b-none">
        ...
        <tr>
            ...
            <td align="left">
                {{Dialog::user('user', $type.'_user_id', '', 0, 0)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                {{Dialog::user('user', $type.'_users', '', 1, 0)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                ...
                - 
                <input type="text" name="end_at" data-toggle="datetime" value="" class="form-control input-sm input-inline">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                {{attachment_uploader('attachment', '')}}
            </td>
        </tr>
