...
<div class="panel m-b-none">
    ...
    <table class="table table-form m-b-none">
        ...
        <tr>
            ...
            <td align="left">
                {{Dialog::user('user','user_id', $task['user_id'], 0, 0)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                {{Dialog::user('user', 'users', $task['users'], 1, 0)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="start_at" data-toggle="datetime" value="@datetime($task->start_at,time())" id="start_at" class="form-control input-sm input-inline"> 
                - 
                <input type="text" name="end_at" data-toggle="datetime" value="@datetime($task->end_at)" id="end_at" class="form-control input-sm input-inline">
            </td>
        </tr>
