...
use Aike\Web\Calendar\CalendarAttachment;
use Aike\Web\Calendar\CalendarObject;
...
class Calendar extends BaseModel
{
    ...
    public function getCalendars($userId, $active = false)
    {
    ...
    public static function addCalendar($userid, $name, $components='VEVENT,VTODO,VJOURNAL', $timezone=null, $order=0, $color=null)
    {
        ...
        $data = array(
            'userid'        => $userid,
            'displayname'   => $name,
            'principaluri'  => 'principals/'.Auth::user()->username,
            'uri'           => $uri,
            'ctag'          => 1,
            'calendarorder' => $order,
            'calendarcolor' => $color,
    ...
    public static function deleteCalendar($id)
    {
        ...
        if (sizeof($events)) {
            foreach ($events as $event) {
                CalendarAttachment::remove($event->attachment);
            }
    ...
    public static function getAccessClassPermissions($vobject)
    {
        ...
        return Calendar::getAccessClassPermissions($accessclass);
    }
    ...
    public static function createVCalendarFromRequest($request)
    {
        ...
        $vcalendar->add('PRODID', 'aikeoa.com Calendar');
    ...
    {
        Calendar::where('id', $id)->increment('ctag');
        return true;
    }
