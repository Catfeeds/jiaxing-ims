    ...
    <div>
      ...
      <div class="wrapper bg-light lter b-b">
        ...
        <div class="pull-right">
                            <a href="javascript:;" onclick="formBox('新建文件夹','{{url('folder', ['folder'=>1,'parent_id'=>$parent_id])}}', 'myfolder');" class="btn btn-default btn-sm"><i class="fa fa-folder-o"></i> 新建</a>
                            <a href="javascript:;" onclick="formBox('上传文件','{{url('upload', ['parent_id' => $parent_id])}}', 'myupload');" class="btn btn-info btn-sm"><i class="fa fa-file-o"></i> 上传文件</a>
                        </div>
                        ...
                        <table class="table m-b-none table-hover">
                            ...
                            <tr>
                                ...
                                <td align='center'>
                                    ...
                                    <a class="option" href="javascript:;" onclick="formBox('重命名','{{url('folder', ['folder'=>$row['folder'],'id' => $row['id'], 'parent_id' => $parent_id])}}', 'myfolder');">重命名</a>
                                    <a class="option" href="javascript:;" onclick="formBox('共享','{{url('sharing', ['id' => $row['id']])}}', 'myshare');">共享</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
