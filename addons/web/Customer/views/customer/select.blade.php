   ...
   <div class="form-group">
    <select id='salesman_id' name='salesman_id' data-toggle="redirect" class='form-control input-sm' @if(Auth::user()->role->name == 'salesman') disabled="true" @endif rel="{{$selects['query']}}">
