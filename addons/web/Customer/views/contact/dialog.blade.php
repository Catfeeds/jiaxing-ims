<div class="padder">
    ...
    <table id="customer-contact-dialog">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="nickname" data-sortable="true" data-align="left">联系人姓名</th>
            <th data-field="customer_name" data-width="200" data-align="left">客户名称</th>
...
(function($) {
    var $table = $('#customer-contact-dialog');
    ...
    search.find('#search-submit').on('click', function() {
        ...
        $table.bootstrapTable('refresh', {
            url: app.url('customer/contact/dialog', data)
        });
        return false;
    });
})(jQuery);
