     	...
     	editor: function(key, i, j) {
    		...
    		switch(type)
    		{
    		    case "empty":
                    ...
                    break;
    		    case "text":
    		    	var out = readonly == 0 ? '<input type="text" style="width:'+size+'px;" class="input-text" name="'+name+'" id="'+id+'" value="'+value+'">' : '<span id="'+id+'">'+value+'</span>';
                    break;
    		    case "textarea":
    		    	var out = readonly == 0 ? '<textarea style="width:'+size+'px;" class="input-text" name="'+name+'" id="'+id+'">'+value+'</textarea>' : '<span id="'+id+'">'+value+'</span>';
                    break;                
    		    case "calc":
    		    ...
    		    case "checkbox":
    		  	...
    		  	case "datetime":
    		    	out = readonly == 0 ? '<input type="text" style=width:'+size+'px;" onfocus="datePicker({dateFmt:\'yyyy-MM-dd\'});" class="input-text popDate" value="'+value+'" name="'+name+'" id="'+id+'">' : '<span id="'+id+'">'+value+'</span>';
                    break;	    
    		}
    		return out;
    	},
