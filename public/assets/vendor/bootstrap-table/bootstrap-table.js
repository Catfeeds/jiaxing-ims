...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        searchText: '',
        iconSize: undefined,
        iconsPrefix: 'icon', // glyphicon of fa (font awesome)
        icons: {
            paginationSwitchDown: 'icon-collapse-down icon-chevron-down',
            paginationSwitchUp: 'icon-collapse-up icon-chevron-up',
            refresh: 'icon-refresh icon-refresh',
            toggle: 'icon-list-alt icon-list-alt',
            columns: 'icon-th icon-th'
        },
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatRecordsPerPage: function (page) {
            return sprintf('%s records per page', page);
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (this.totalPages > 0 && this.options.page > this.totalPages) {
            this.options.page = this.totalPages;
        }

        this.pageFrom = (this.options.page - 1) * this.options.pageSize + 1;
        this.pageTo = this.options.page * this.options.pageSize;
        ...
        for (i = from; i <= to; i++) {
            html.push('<li class="page-number' + (i === this.options.page ? ' active' : '') + '">',
    ...
    BootstrapTable.prototype.updatePagination = function (event) {
        ...
        this.trigger('page-change', this.options.page, this.options.pageSize);
    };
    ...
    BootstrapTable.prototype.onPageNumber = function (event) {
        if (this.options.page === +$(event.currentTarget).text()) {
            return;
        }
        this.options.page = +$(event.currentTarget).text();
        this.updatePagination(event);
    };
        ...
        if (this.options.queryParamsType === 'limit') {
            ...
            if (this.options.pagination) {
                ...
                params.offset = this.options.pageSize === this.options.formatAllRows() ?
                    0 : this.options.pageSize * (this.options.page - 1);
