<li class="dropdown hidden-xs" id="notify-app">
    ...
    <div class="dropdown-menu w-xl">
        ...
        <div class="panel bg-white">
            ...
            <div class="list-group no-radius">
                ...
                <a href="javascript:addTab('<?php echo url('index/notify/index'); ?>', '00', '通知提醒');" title="通知提醒" v-if="count.notify > 0" class="list-group-item">
                    <span class="pull-left thumb-sm">
                        <i class="fa fa-bell-o fa-2x text-info"></i>
                    </span>
                    <span class="block m-b-none">
                        <span><span class="text-danger pull-right-xs">{{count.notify}}</span> 条未读通知</span>
                        <br>
...
new Vue({
    ...
    methods: {
        ...
        getItems: function() {
            var me = this;
            var notify = 0;
            $.get(app.url('index/notify/remind'), function(count) {
                if(notify == count) {
                    return;
                }
                me.count.total  = count;
                me.count.notify = count;
            }, 'json');
        }
    },
    mounted: function() {
