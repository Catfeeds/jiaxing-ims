...
class App
{
    ...
    public function queryAppInfo()
    {
        ...
        return Util::httpGet($this->appendToken($url))["content"];
    }
    ...
    {
        if ($data["agentid"]) {
            return Util::httpPost($this->appendToken("https://qyapi.weixin.qq.com/cgi-bin/agent/set"), $data)["content"];
        } else {
    ...
    public function sendMsgToUser($msg)
    {
        ...
        return Util::httpPost($this->appendToken($url), $msg)["content"];
    }
}
