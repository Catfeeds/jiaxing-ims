...
class QRCode
{
    ...
    public function createImage($size = 2, $margin = 2)
    {
...
class QRRSBlock
{
    ...
    public function QRRSBlock($totalCount, $dataCount)
    {
...
{
    public function QR8BitByte($data)
    {
...
class QRMath
{
    public static $QR_MATH_EXP_TABLE;
    public static $QR_MATH_LOG_TABLE;

    public static function init()
    {
        static::$QR_MATH_EXP_TABLE = QRMath::createNumArray(256);

        for ($i = 0; $i < 8; $i++) {
            static::$QR_MATH_EXP_TABLE[$i] = 1 << $i;
        }

        for ($i = 8; $i < 256; $i++) {
            static::$QR_MATH_EXP_TABLE[$i] = static::$QR_MATH_EXP_TABLE[$i - 4]
                ^ static::$QR_MATH_EXP_TABLE[$i - 5]
                ^ static::$QR_MATH_EXP_TABLE[$i - 6]
                ^ static::$QR_MATH_EXP_TABLE[$i - 8];
        }
        
        static::$QR_MATH_LOG_TABLE = QRMath::createNumArray(256);

        for ($i = 0; $i < 255; $i++) {
            static::$QR_MATH_LOG_TABLE[static::$QR_MATH_EXP_TABLE[$i] ] = $i;
        }
    }
    ...
    public static function glog($n)
    {
        ...
        return static::$QR_MATH_LOG_TABLE[$n];
    }
    ...
    public static function gexp($n)
    {
        ...
        return static::$QR_MATH_EXP_TABLE[$n];
    }
}
...
class QRPolynomial
{
    ...
    public function QRPolynomial($num, $shift = 0)
    {
        $offset = 0;
